    ...
    <Card className="mx-auto max-w-md w-full">
      <CardHeader className="space-y-2">
        ...
        <CardTitle className="text-2xl font-headline text-center">
          Start your journey as a student with AI - UniHub.
        </CardTitle>
      </CardHeader>
      <CardContent>
        <div className="grid gap-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="grid gap-2">
              ...
              <Input id="firstName" placeholder="Max" required onChange={handleInputChange} value={formData.firstName} disabled={isLoading} />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="lastName">Last name</Label>
              <Input id="lastName" placeholder="Robinson" required onChange={handleInputChange} value={formData.lastName} disabled={isLoading} />
            </div>
          </div>
          <div className="grid gap-2">
            <Label htmlFor="email">Email</Label>
            <Input id="email" type="email" placeholder="m@example.com" required onChange={handleInputChange} value={formData.email} disabled={isLoading} />
          </div>
          <div className="grid gap-2">
            <Label htmlFor="college">Select your College</Label>
            <Select onValueChange={handleSelectChange} value={formData.college} disabled={isLoading}>
          ...
          <div className="grid gap-2">
            ...
            <RadioGroup defaultValue={formData.education} onValueChange={handleRadioChange} className="flex gap-4" disabled={isLoading}>
          ...
          <div className="grid gap-2 relative">
            ...
            <Input id="password" type="password" onChange={handleInputChange} value={formData.password} disabled={isLoading} />
